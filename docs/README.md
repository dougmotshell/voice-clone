...
**[Architecture Decision Records](adr/)** — dez decisões registradas, com o
...
| Diagnosticar erro de import | Rode `falar.py checar`; depois [ADR-0003](adr/0003-io-audio-via-soundfile.md) e [ADR-0009](adr/0009-transformers-5-por-reposicao-de-simbolo.md) |
| Instalar em macOS ou Windows | [Manual](MANUAL.md) §2 e [ADR-0010](adr/0010-portabilidade-tres-plataformas.md) |
| Rodar em contêiner | [Manual](MANUAL.md) §6 e [SDD](SDD.md) §5.4 |
